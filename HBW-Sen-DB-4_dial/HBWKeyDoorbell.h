...
// #define DB_PHONE_DIAL // experimential channel to trigger phone calls
...
class HBWKeyDoorbell : public HBWChannel {
  public:
    ...
    HBWKeyDoorbell(uint8_t _pin, hbw_config_key_doorbell* _config, HBWPhoneDial* _phone_dial_chan, uint8_t _pinBuzzer = NOT_A_PIN, bool _activeHigh = false);
